document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    if (cocktailQuestionsDivEl) {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            console.log(i.toString() + cocktailQuestions.questions[q].correct[i]);
            ...
            buttonEls[button.id].addEventListener("click", function() {
                console.log("*****" + button.id + this.id + buttonEls[this.id].getAttribute("data-answer"));
                if (buttonEls[this.id].getAttribute("data-answer") === "correct") {
                //if (cocktailQuestions.questions[q].correct[this.id]) {
                ...
                console.log("q after q++ "+q);

                if (q < 7) {
                    console.log("calling function with q="+q);
